                ...
                <div class="bg-white p-6 rounded-lg w-1/2 relative max-h-screen overflow-y-auto">
                    ...
                    <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="col-span-1">
                            ...
                            <select id="type_id" wire:model="editedTask.type_id"
                                class="bg-gray-100 p-2 rounded w-full" wire:keyup="updateTaskRealTime">
                        ...
                        <div class="col-span-1">
                            ...
                            <select id="priority_id" wire:model="editedTask.priority_id"
                                ...
                                @foreach ($priorities as $priority)<div>
...
<div class="w-full overflow-hidden rounded-lg shadow-xs">
    ...
    {{ $projects->links('livewire::tailwind') }}
                        ...
                        <div class="col-span-1">
                            ...
                            <input id="order" type="number" wire:model="editedTask.order"
                                placeholder="Enter Order" class="bg-gray-100 p-2 rounded w-full"
                                wire:keyup="updateTaskRealTime" />
                        </div>
