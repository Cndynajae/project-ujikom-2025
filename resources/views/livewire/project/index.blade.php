                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    @foreach ($projects as $project)
                        <tr class="text-gray-700 dark:text-gray-400">
                            ...
                            <td class="px-4 py-3 text-sm">{{ $project->owner ? $project->owner->name : 'No Owner' }}</td>
                            <td class="px-4 py-3 text-sm">{{ $project->status ? $project->status->name : 'No Status' }}</td>
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    ...
                                    <dialog id="my_modal_{{ $project->id }}"
                                        ...
                                        <div
                                            ...
                                            <h3 class="text-lg font-bold"><center>Do you want to delete this project?</center></h3>
